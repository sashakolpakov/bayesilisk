...
- Scenario: `external.4` (context-observed)
...
- Observation: expected semantic status 404, observed 200 on `/{username}/{eventType}?rescheduleUid={rescheduleUid}&bookingUid=null`
...
```json
{
  ...
  "dataSignals": {
    ...
    "targetUrl": "http://localhost:3000/user-0-1779068495757/30-min?rescheduleUid=missing-rescheduleUid&bookingUid=null"
  },
  "decision": null,
  "expenseCategories": [],
  "modules": {},
  "routes": [
    "/{username}/{eventType}?rescheduleUid={rescheduleUid}&bookingUid=null"
  ],
  "transportModes": []
}
```
...
````markdown
Scenario `calcom.unknown_reschedule_uid_must_not_open_booking_flow`: TODO says missing rescheduleUid should force 404: unknown id for rescheduleUid.
...
Target URL: `http://localhost:3000/user-0-1779068495757/30-min?rescheduleUid=missing-rescheduleUid&bookingUid=null`
...
```json
{
  ...
  "dataSignals": {
    ...
    "targetUrl": "http://localhost:3000/user-0-1779068497200/30-min?rescheduleUid=stale-rescheduleUid&bookingUid=null"
  },
  "decision": null,
  "expenseCategories": [],
  "modules": {},
...
````markdown
Scenario `calcom.unknown_reschedule_uid_must_not_open_booking_flow`: TODO says missing rescheduleUid should force 404: stale id for rescheduleUid.
...
Target URL: `http://localhost:3000/user-0-1779068497200/30-min?rescheduleUid=stale-rescheduleUid&bookingUid=null`
...
- Scenario: `external.6` (context-observed)
...
- Observed result: `fail`
- Observation: expected semantic status 404, observed 200 on `/d/{hashedLink}/{eventType}?rescheduleUid={rescheduleUid}`
- Observation basis: `confirmed-local-breakage`
- Attention score: `1.000000`
- Attention reasons: `connector-evidence, external-context-failure`
- Risk score: `0.990000`
...
```json
{
  ...
  "dataSignals": {
    ...
    "targetUrl": "http://localhost:3000/d/rqwVd9TL8ANJKg43917cA7/30-min?rescheduleUid=missing-rescheduleUid"
  },
  "decision": null,
  "expenseCategories": [],
  "modules": {},
  "routes": [
    "/d/{hashedLink}/{eventType}?rescheduleUid={rescheduleUid}"
  ],
  "transportModes": []
}
```
...
````markdown
Scenario `calcom.private_link_unknown_reschedule_uid_must_not_open_booking_flow`: Private booking link resolves rescheduleUid into booking context: unknown id for rescheduleUid.
...
Target URL: `http://localhost:3000/d/rqwVd9TL8ANJKg43917cA7/30-min?rescheduleUid=missing-rescheduleUid`
...
- Scenario: `external.7` (context-observed)
...
```json
{
  ...
  "dataSignals": {
    ...
    "targetUrl": "http://localhost:3000/d/5FtfktPEM3xLr7NAkk4sbY/30-min?rescheduleUid=stale-rescheduleUid"
  },
  "decision": null,
  "expenseCategories": [],
  "modules": {},
...
````markdown
Scenario `calcom.private_link_unknown_reschedule_uid_must_not_open_booking_flow`: Private booking link resolves rescheduleUid into booking context: stale id for rescheduleUid.
...
Target URL: `http://localhost:3000/d/5FtfktPEM3xLr7NAkk4sbY/30-min?rescheduleUid=stale-rescheduleUid`
...
- Observed result: `fail`
- Observation: expected semantic status 404, observed 200 on `/{username}+{username}?rescheduleUid={rescheduleUid}`
- Observation basis: `confirmed-local-breakage`
- Attention score: `1.000000`
- Attention reasons: `connector-evidence, external-context-failure`
- Risk score: `0.990000`
...
```json
{
  ...
  "dataSignals": {
    ...
    "targetUrl": "http://localhost:3000/user-0-1779068498525+bayesilisk-dynamic-nwd4Ce-0-1779068498766?rescheduleUid=missing-rescheduleUid"
  },
  "decision": null,
  "expenseCategories": [],
  "modules": {},
  "routes": [
    "/{username}+{username}?rescheduleUid={rescheduleUid}"
  ],
  "transportModes": []
}
```
...
````markdown
Scenario `calcom.dynamic_booking_unknown_reschedule_uid_must_not_open_booking_flow`: Dynamic booking page has a passing valid reschedule flow: unknown id for rescheduleUid.
...
Target URL: `http://localhost:3000/user-0-1779068498525+bayesilisk-dynamic-nwd4Ce-0-1779068498766?rescheduleUid=missing-rescheduleUid`
...
```json
{
  ...
  "dataSignals": {
    ...
    "targetUrl": "http://localhost:3000/user-0-1779068499115+bayesilisk-dynamic-yE8Y06-0-1779068499351?rescheduleUid=stale-rescheduleUid"
  },
  "decision": null,
  "expenseCategories": [],
  "modules": {},
...
````markdown
Scenario `calcom.dynamic_booking_unknown_reschedule_uid_must_not_open_booking_flow`: Dynamic booking page has a passing valid reschedule flow: stale id for rescheduleUid.
...
Target URL: `http://localhost:3000/user-0-1779068499115+bayesilisk-dynamic-yE8Y06-0-1779068499351?rescheduleUid=stale-rescheduleUid`
